			    ...
			    $(document).ready(function() {
                    ...
                    if("${afiche.idafiche}"== ""){
	                    ...
	                    {	
	                    	...
	                    	$("#buttonFile").attr('disabled', 'disabled');
	                    	$("#url").attr('disabled', 'disabled');
	                    	$("#body-popup").append('<li>Fecha de Actualización:</li> <li id="right-li"><fmt:formatDate value="${afiche.fechaactualizacion}" type="date" pattern="dd/MM/yyyy"/></li>');
	                    	$("#imageInput").attr('disabled', 'disabled');
	                    	$('#oficinas').multiselect({
		                        includeSelectAllOption: false,
					        	enableCaseInsensitiveFiltering: true
...
<!--                                     <label id="errorOfi"  class="error " style="display:none;">Escoger Oficina</label> -->
                                ...
                                <li>Descripción:</li>
                              	<li id="right-li"><form:textarea class="validate[required]" path="descripcion" id="text-area-1" ></form:textarea></li>
                              	
                                <li>Mostrar Miniatura:</li>
                                <li id="right-li"><form:checkbox id="checkMiniatura" path="miniatura" value="S" />
                                </li>
                                <li>Fecha de Creación:</li>
                                <li id="right-li"><fmt:formatDate value="${afiche.fechacreacion}" type="date" pattern="dd/MM/yyyy"/></li>
