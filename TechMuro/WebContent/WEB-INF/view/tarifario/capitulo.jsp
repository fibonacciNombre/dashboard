...
<script>
	...
	function llenarTabla() {
		...
		grid.jqGrid({
			datatype : 'local',
			data : mydata,
			colNames : [ "ID","Nombre de Capítulo", "Orden", "Ver<br/>Sub-Capítulos", "Ver<br/>Rubros", "Ver<br/>Notas", "Editar", "Eliminar" ],
...
<body>
	<div id="block-grid">
		...
		<div id="back-title"><h1>Tarifarios > Productos > <span>Capítulos</span></h1></div>
							...
							<li>
								<a href="#" id="container-button-add" onclick="return openForm();">
									...
									<div id="button-add-center">
										<span class="icon-plus-button">Agregar Capítulo</span>
									</div>
