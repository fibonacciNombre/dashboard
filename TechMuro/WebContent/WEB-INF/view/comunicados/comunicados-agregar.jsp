...
// 							    	$("#url").css("background","#ccc");
	                    ...
	                    {	
	                    	...
	                    	//$("#url").attr('disabled', 'disabled');
	                    	$("#body-popup").append('<li>Fecha de Actualización:</li> <li id="right-li"><fmt:formatDate value="${comunicado.fechaactualizacion}" type="date" pattern="dd/MM/yyyy"/></li>');
	                    	$("#imageInput").attr('disabled', 'disabled');
	                    	$('#oficinas').multiselect({
		                        includeSelectAllOption: false,
					        	enableCaseInsensitiveFiltering: true
                    ...
                    $('#guardar').click(function(){
                    	...
                    	var options = $('#oficinas > option:selected');
						 ...
						 if(b && v){
					 		...
					 		$('#subirAfiche').ajaxForm({url:"../addComunicado/"+x+".htm",type:"post", success:function(data){
                ...
                <div class="overlay" id="overlay" style="display:none;">
                    ...
                    <a class="boxclose" id="boxclose"></a>
                        ...
                        <form:form method="post" id="subirAfiche"  class="scrollbar" enctype="multipart/form-data" modelAttribute="uploadedFile" commandName="comunicado">
                            <ul id="body-popup">
                            	<li>Título</li>
                                <li id="right-li"><form:input name="" value="" type="text" id="url" class="input-popup-2" path="titulo"/></li>
...
<%--                                 <li id="right-li"><form:input name="" value="" type="text" id="url" class="validate[custom[onlyNumberSp]] input-popup-2" path="video"/></li> --%>
                                <li>Descripción:</li>
                              	<li id="right-li" class="descText" >
	                              	...
	                              	<div id="divDesc" style="width: 290px; height: 100px;line-height: 15px;background: #f7f7f7;border: 1px solid #e9e9e9;color: #555;">${comunicado.descripcion}</div>
	                              	<form:textarea path="descripcion" id="text-area-1" style="display:none;"></form:textarea>
...
<!--                                 </li> -->
                                ...
                                <li id="right-li"><fmt:formatDate value="${comunicado.fechacreacion}" type="date" pattern="dd/MM/yyyy"/></li>
